  ...
  <div class="w-full flex flex-col h-screen overflow-y-hidden">
    <div class="w-full overflow-x-hidden border-t flex flex-col">
      <main class="w-full flex-grow p-6">
        <h1 class="text-3xl text-black mb-2">Roles</h1>
        @can('role-create')
          ...
          <div class="bg-white overflow-auto">
            <table class="min-w-full table-auto border-collapse border-2 border-blue-light">
              ...
              <tbody>
                ...
                <tr>
                  <td class="border border-blue-light p-2">{{$role->id}}</td>
                  <td class="border border-blue-light p-2">{{$role->name}}</td>
                  <td class="border border-blue-light p-2">
                    ...
                    <a class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-yellow-600 text-white hover:bg-yellow-500"
                    ...
                    <button
                      ...
                      onclick="toggleModal('modal-{{$role->id}}')">Delete</button>
                      ...
                      <div
                        ...
                        <div
                          ...
                          <button
                            ...
                            onclick="toggleModal('modal-{{$role->id}}')">
                            <span
                        ...
                        <div class="flex items-center justify-end p-6 border-t border-solid border-gray-300 rounded-b">
                          <button
                            ...
                            type="button" style="transition: all .15s ease" onclick="toggleModal('modal-{{$role->id}}')">
                            Close
                          </button>
                          {!! Form::open(['method' => 'DELETE','route' => ['roles.destroy',
                          $role->id],'style'=>'display:inline']) !!}
                          {!! Form::submit('Delete', ['class' => 'bg-red-500 text-white active:bg-red-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1
                          cursor-pointer']) !!}
                          {!! Form::close() !!}
                        </div>
                      </div>
